...
const String kEndoscopicUltrasound =
    """EUS or endoscopic ultrasound implies visualizing visceral organs using ultrasound probes equipped on one end of imaging devices that are specialized in digestive system endoscopy.
...
const String kElectrophisiolgy =
    """It is a state of the art machine that is used for the treatment of irregular heartbeats.
...
const String kSingleDoseRadiotherapy =
    """Radiation beams are directly delivered to the target while surgically removing tumors of patients.
...
const String kImagingandNavigationSystem =
    """Medtronic plc has launched its new StealthStation technology. In prior iterations, StealthStation technology has been a mainstay in neurosurgery suites for the past 25 years, being used in more than 2.25 million procedures.  
...
const String kMRI =
    """It is used especially in brain surgeries to inform the surgeon on size and direction of the tumors that are not easily accessible. Thus, the surgeon decides either to terminate or continue the operation.
...
const String kCT = """Advanced Intelligent Clear-IQ Engine (AiCE)
...
const String kDigitalMammography =
    """Three-dimensional mammography (breast tomosynthesis) scans the breast tissue in three dimensions. Multiple images of breast tissue are acquired on various projections and three-dimensional image of breast tissue is created at 1-mm intervals.
...
const String kLapReport = """
Medical Laboratory Report - Laboratory of Medical Analysis

Medical analyses were performed on the following samples, and the results were as follows:

Sample 1: A blood sample was analyzed, and the results showed a high level of red blood cells and an increase in hemoglobin level. This indicates the presence of anemia.

Sample 2: A urine sample was analyzed, and the results showed a high level of protein and red blood cells. This may indicate the presence of a urinary tract infection.

Sample 3: A stool sample was analyzed, and the results showed the presence of certain bacteria and viruses. This may indicate the presence of an infection in the digestive system.

Sample 4: A urine sample was analyzed, and the results showed no significant changes. This indicates that there are no problems in the urinary tract.

Therefore, it can be concluded that samples 1, 2, and 3 require further medical follow-up to confirm the diagnosis and determine the appropriate treatment, while sample 4 is within normal limits and there are no health problems to be concerned about
""";

const String kRadiology = """
Medical Radiology Report - Brain Magnetic Resonance Imaging

A brain magnetic resonance imaging (MRI) was performed, and the images were analyzed as follows:

Brain: No significant changes were observed in the overall size or shape of the brain.

Cerebellum: A blockage was identified in the upper cerebral sulcus, which can lead to some balance and movement-related symptoms.

Septum pellucidum: No significant changes were observed in the septum pellucidum.

Brain: A small tumor was discovered in the frontal cortex of the brain, and it appears to be benign. However, further tests are needed to determine the nature of the tumor and the necessary steps for follow- up.

Therefore, it can be concluded that the patient needs further medical follow-up to determine the nature of the blockage in the cerebral sulcus and how to deal with it, as well as to determine the nature of the tumor and take the necessary steps for follow-up.""";
